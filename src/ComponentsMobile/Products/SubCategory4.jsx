...
export default function SubCategory4() {
    useEffect(() => {
        window.scrollTo(0, 0);
      }, []);
  return (
...
<div className="container">
           ...
           <Link to='/subProduct5' style={{textDecoration:'none'}}>  <div className='m-3' style={{backgroundColor:'#fff', borderRadius:'15px', padding:'3%',width:'326px', height:'715px',boxShadow: '3px 3px 6px 2px rgb(0 0 0 / 30%)'}}>
   ...
   <div className="imageContainer" style={{padding:'0'}}> 
       ...
       <p style={{color:'#707070', fontSize:'17px',lineHeight:'22px', textAlign:'center',fontFamily:'Segoe UI Regular',marginBottom:'13%'}}>imageRUNNER ADVANCE DX 8795i</p>
      
 <div className="divo" style={{display:'flex', alignItems:'center',paddingBottom:'15px',paddingLeft:'8px'}}>
 <img src={dot} style={{marginRight:'12px'}} alt="" /> <p style={{color:'#707070',fontFamily:'Segoe UI Regular', fontSize:'16px', lineHeight:'15px', textAlign:'left',marginBottom:'0'}}>Print up to 95 ppm (BW/color) </p>
