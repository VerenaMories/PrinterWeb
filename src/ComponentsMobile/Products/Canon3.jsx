...
export default function Canon3() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  return (
...
<div className='m-3' style={{backgroundColor:'#fff', borderRadius:'15px', padding:'3%',width:'326px', height:'715px',boxShadow: '3px 3px 6px 2px rgb(0 0 0 / 30%)'}}>
                <div className="imageContainer" style={{padding:'0'}}>    <img src={ifz} alt="" />
</div>
<div className="imageContainer" style={{padding:'0'}}> 
    <img src={canon} alt="" /></div>


    <p style={{color:'#707070', fontSize:'17px',lineHeight:'22px', textAlign:'center',fontFamily:'Segoe UI Regular',marginBottom:'13%'}}>imageRUNNER ADVANCE DX C568ifz</p>
