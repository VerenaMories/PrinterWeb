                ...
                <div className="imageContainer" >
					...
					<div className="col-md-12 p-4">
						<div
							...
							style={{ boxShadow: "1px 2px 2px 2px rgb(0 0 0 / 30%)" }}
						>
							<div className="divShadow container p-3">
								<Link style={{ textDecoration: "none" }} to="/subBuild">
									<div
										style={{
											display: "flex",
									...
									>
										...
										>
											<img
												src={Group601}
												alt=""
												style={{ marginTop: "15%", mixBlendMode: "luminosity" }}
											/>
											<p
												style={{
													color: "#EC1F26",
								...
								<Link style={{ textDecoration: "none" }} to="/subBuild2">
									<div
										style={{
											display: "flex",
											justifyContent: "center",
