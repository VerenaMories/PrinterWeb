...
import Group601 from '../../images/Group 721.png';
import Group575 from '../../images/Group 722.png';
...
<div style={{backgroundColor:'rgba(109, 107, 107, 0.33)',borderRadius:'74px',width:'821px', height:'355px',boxShadow: '3px 3px 6px 2px rgb(0 0 0 / 30%)', display:'flex', justifyContent:'center', alignItems:'center'}}>
  <div className="row">
    <div className="col">   <Link style={{textDecoration:'none'}} > 
   ...
   <div style={{display:'flex', justifyContent:'center'}}>    <img src={Group601} alt="" style={{marginTop:'15%'}}/>
</div>

    <p style={{color:'#EC1F26', fontSize:'16px',lineHeight:'18px', textAlign:'center',fontFamily:'a Atmospheric', paddingTop:'2%'}}>paper size <br />
letter </p>
