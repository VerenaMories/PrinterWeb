    ...
    <div className="container ">
        ...
        {/* <div className="col-md-12">
            ...
            <div style={{display:'flex', justifyContent:'center' , marginTop:'5%'}}>
              ...
              <Link to='/subCanon2' style={{textDecoration:'none'}}>
            
<div  style={{backgroundColor:'#fff', borderRadius:'15px', padding:'3%',boxShadow: '3px 3px 6px 2px rgb(0 0 0 / 30%)'}}>
                <div className="imageContainer" style={{display:'flex', justifyContent:'center', alignItems:'center'}}>    <img src={if2} alt="" />
</div>
<div className="imageContainer" style={{display:'flex', justifyContent:'center', alignItems:'center'}}> 
    <img src={canon} alt="" /></div>


    <p style={{color:'#707070', fontSize:'17px',lineHeight:'22px', textAlign:'center',fontFamily:'Segoe UI Regular',marginBottom:'13%'}}>imageRUNNER ADVANCE DX C478if</p>
